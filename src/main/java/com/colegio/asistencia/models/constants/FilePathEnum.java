package com.colegio.asistencia.models.constants;
...
public enum FilePathEnum {
    ...
    PATH_TEMPLATE_HTML_FORM_UPDATED_STUDENT("secretary/modificar-estudiante"),
    PATH_TEMPLATE_HTML_SHOW_STUDENTS("teacher/asistencia");
